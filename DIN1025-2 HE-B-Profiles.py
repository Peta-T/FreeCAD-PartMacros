...
if not os.path.exists(directory):
    os.mkdir(directory)
directory =LIBRARYPATH+'/Mechanical Parts/Profiles EN/DIN1025-2 HE-B-Profiles/'
if not os.path.exists(directory):
    os.mkdir(directory)

Table = (
         ("HE-B-Profile 100 DIN1025-2 S235JR",	100.00,	100.00,	6.00,	10.00,	12.00),
         ("HE-B-Profile 120 DIN1025-2 S235JR",	120.00,	120.00,	6.50,	11.00,	12.00),
         ("HE-B-Profile 140 DIN1025-2 S235JR",	140.00,	140.00,	7.00,	12.00,	12.00),
         ("HE-B-Profile 160 DIN1025-2 S235JR",	160.00,	160.00,	8.00,	13.00,	15.00),
         ("HE-B-Profile 180 DIN1025-2 S235JR",	180.00,	180.00,	8.50,	14.00,	15.00),
         ("HE-B-Profile 200 DIN1025-2 S235JR",	200.00,	200.00,	9.00,	15.00,	18.00),
         ("HE-B-Profile 220 DIN1025-2 S235JR",	220.00,	220.00,	9.50,	16.00,	18.00),
         ("HE-B-Profile 240 DIN1025-2 S235JR",	240.00,	240.00,	10.00,	17.00,	21.00),
         ("HE-B-Profile 260 DIN1025-2 S235JR",	260.00,	260.00,	10.00,	17.50,	24.00),
         ("HE-B-Profile 280 DIN1025-2 S235JR",	280.00,	280.00,	10.50,	18.00,	24.00),
         ("HE-B-Profile 300 DIN1025-2 S235JR",	300.00,	300.00,	11.00,	19.00,	27.00),
         ("HE-B-Profile 320 DIN1025-2 S235JR",	320.00,	300.00,	11.50,	20.50,	27.00),
         ("HE-B-Profile 340 DIN1025-2 S235JR",	340.00,	300.00,	12.00,	21.50,	27.00),
         ("HE-B-Profile 360 DIN1025-2 S235JR",	360.00,	300.00,	12.50,	22.50,	27.00),
         ("HE-B-Profile 400 DIN1025-2 S235JR",	400.00,	300.00,	13.50,	24.00,	27.00),
         ("HE-B-Profile 450 DIN1025-2 S235JR",	450.00,	300.00,	14.00,	26.00,	27.00),
         ("HE-B-Profile 500 DIN1025-2 S235JR",	500.00,	300.00,	14.50,	28.00,	27.00),
         ("HE-B-Profile 550 DIN1025-2 S235JR",	550.00,	300.00,	15.00,	29.00,	27.00),
         ("HE-B-Profile 600 DIN1025-2 S235JR",	600.00,	300.00,	15.50,	30.00,	27.00),
         ("HE-B-Profile 650 DIN1025-2 S235JR",	650.00,	300.00,	16.00,	31.00,	27.00),
         ("HE-B-Profile 700 DIN1025-2 S235JR",	700.00,	300.00,	17.00,	32.00,	27.00),
         ("HE-B-Profile 800 DIN1025-2 S235JR",	800.00,	300.00,	17.50,	33.00,	30.00),
         ("HE-B-Profile 900 DIN1025-2 S235JR",	900.00,	300.00,	18.50,	35.00,	30.00),
         ("HE-B-Profile 1000 DIN1025-2 S235JR",	1000.0,	300.00,	19.00,	36.00,	30.00))
